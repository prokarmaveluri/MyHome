...
public class CreateAppointmentRequest {
    ...
    public CreateAppointmentRequest(String doctorName, String providerNpi, String scheduleId, ProviderDetailsAddress location, Profile bookingProfile, AppointmentTime bookingAppointment, AppointmentType appointmentType, boolean isBookingForMe){
        ...
        setData(new Data("visits", new Attributes(doctorName, providerNpi, location, bookingProfile, bookingAppointment, appointmentType, isBookingForMe), relationships));
    }
