...
public class ApiInteractor implements ApiContract.Interactor {
    final ApiContract.InteractorOutput output;

    public ApiInteractor(ApiContract.InteractorOutput output) {
        this.output = output;
    }


    @Override
    public void getApiOptions() {
        ArrayList<ApiOption> apiOptions = new ArrayList<>();
        ...
        output.receivedApiOptions(apiOptions);
    }
}
